...
//go:generate swagger generate server --target ../../../../../../Involvio --name Involvio --spec ../../../../../docs/swagger2.yaml --api-package api --model-package internal/entity --server-package internal/handler/rest/v1/route --implementation-package github.com/Slava02/Involvio/internal/app --principal interface{}

// This file auto configures the api backend implementation.
// app package must already exist.
// app.New() is implemented by user, and must return an object
// or interface that implements Handler interface defined below.
var Impl Handler = app.New()
